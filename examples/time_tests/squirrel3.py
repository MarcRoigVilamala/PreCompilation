...
__all__ = ['squirrel3', 'Squirrel3Random', 'squirrel3_0to1', 'squirrel3_boolean']
...
"""
The code below is an extension made by Marc Roig Vilamala to allow for calls that return a float between 0 and 1
as well as a boolean value 
"""
HALF_CAP = CAP / 2


def squirrel3_0to1(n, seed=0):
    return squirrel3(n, seed) / CAP


def squirrel3_boolean(n, seed=0):
    return squirrel3(n, seed) > HALF_CAP
